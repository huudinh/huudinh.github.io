<?php
    ...
    if ( is_page_template( 'templates/page_home.php' ) ) {
        ...
        include(locate_template("Module/Post/faqs_mz_1_0_0/sass/faqs_mz_1_0_0.min.css"));	
        include(locate_template("Module/Post/otherNews_mz_1_0_0/sass/otherNews_mz_1_0_0.min.css"));	
