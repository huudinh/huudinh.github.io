const popup_regist_1_0_0 = `
    ...
    <form class="popup_regist_1_0_0__boxTv" id="popup_regist_1_0_0">
        ...
        Validator({
            ...
            rules: [
                ...
                Validator.addInput('#itext', () => {
                    return 'Tên khách hàng: ' + document.querySelector('#popup_regist_1_0_0 #iname').value + ' Sử dụng dịch vụ: ' + document.querySelector('#popup_regist_1_0_0 #iservice').value;
                }),
            ],
